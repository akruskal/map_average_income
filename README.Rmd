...
Aus_median_weekly_income <-  AUST_medians$Med_tot_psnl_incom_weekly
CED_medians$Med_tot_family_inc_weekly_diff <- Aus_median_weekly_income - CED_medians$Med_tot_psnl_incom_weekly
```
...
pallet_fn <- colorNumeric(..., c(MIN_DIFF, MAX_DIFF))
```
